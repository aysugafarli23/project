    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section_lesson', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='module.lesson')),
                ('section_module', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='module.module')),
            ],
        ),
        migrations.CreateModel(
            name='Content',
